    ...
    return BlocBuilder<AuthCubit, AuthState>(
      builder: (context, state) => switch (state) {
        AuthReady(:final outletId) => MultiBlocProvider(
            providers: [
              BlocProvider(
                  create: (context) => ProductMasterCubit()..init(outletId)),
              BlocProvider(
                  create: (context) =>
                      ProductMasterCategoryCubit()..init(outletId)),
            ...
            child: RefreshIndicator(
              ...
              child: Column(
                ...
                children: [
                      ...
                      builder: (context, filterState) {
                        return BlocBuilder<ProductMasterCategoryCubit,
                          ...
                          return ProductCategoryFilter(
                            ...
                            categories:
                                state is ProductMasterCategoryLoadSuccess
                                    ? state.categories
                                    : [],
                            errorText: state is ProductMasterCategoryLoadFailure
                                ...
                                : "",
                            loading:
                                state is ProductMasterCategoryLoadInProgress,
                          );
                        });
                      },
                    ),
                  ...
                  Expanded(
                      child:
                          BlocBuilder<ProductMasterCubit, ProductMasterState>(
                    builder: (context, state) => switch (state) {
