...
class VirtualAccountWaitingPayment extends StatefulWidget {
  const VirtualAccountWaitingPayment({super.key, required this.arguments});

  final PurchaseArgument arguments;

  @override
  State<VirtualAccountWaitingPayment> createState() =>
      _VirtualAccountWaitingPaymentState();
}

class _VirtualAccountWaitingPaymentState
    extends State<VirtualAccountWaitingPayment>
  ...
  void initState() {
    ...
    _targetTime = widget.arguments.purchases.paymentRequest.paymentMethod
        .virtualAccount!.channelProperties.expiresAt;
            ...
            child: Column(
              ...
              children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  UiIcons(
                                    ...
                                    onTap: () => _onCopy(text: virtualAccount),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            child: Row(
                              children: [
                                ...
                                UiIcons(
                                  ...
                                  size: 20,
                                  color: TColors.primary,
                                  onTap: () => _onCopy(text: amount.toString()),
                                ),
                              ],
                            ),
                          ),
                ...
                BlocBuilder<PurchaseCubit, PurchaseState>(
                  ...
                  bool isLoading =
                      state is PurchaseDetailInProgress && _checkStatusPayment;
                  return SizedBox(
