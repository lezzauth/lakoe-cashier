...
_$ListHistoryPurchaseModelImpl _$$ListHistoryPurchaseModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$ListHistoryPurchaseModelImplToJson(
        _$ListHistoryPurchaseModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'paymentMethod': instance.paymentMethod,
      'status': instance.status,
